                ...
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col=lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="name" placeholder="Enter name" name="name" onkeypress="return inputOnlyText(event)">
                          </div>
                      </div>
                      <div class="col=lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col=lg-6 col-md-6 col-sm-12">
                          ...
                          <input type="text" class="form-control" id="contact_number" placeholder="Enter contact number" name="contact_number" onkeypress="return validatePhone(event)">
                        </div>
                      </div>
                      <div class="col=lg-6 col-md-6 col-sm-12">
                          <div class="form-group">

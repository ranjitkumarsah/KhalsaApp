    ...
    <div class="container-fluid icons-dashboard">
      <div class="row ">
        <div class="col-xl-2 col-md-6 col-6">
          <a href="{{url('Admin/subadmin')}}" class="box" >
            <div class="box-body text-center">
              <div class="bg-primary-light rounded10 p-20 mx-auto ">
                <img src="../public/images/icons/svg.svg" class="text-secondary mt-3" alt="" style="width: 27%;" />
              </div>
              <p class="text-fade mt-15 mb-5" style="font-size: 0.8rem;line-height: 21px;">Total Subadmin</p>
              <h2 class="mt-0">{{$subadmin}}</h2>
            </div>
          </a>
        </div>
        <div class="col-xl-2 col-md-6 col-6">
          <a href="{{url('Admin/view_doctor')}}" class="box" >
            <div class="box-body text-center">
        ...
        <div class="col-xl-2 col-md-6 col-6">
          <a href="{{url('Admin/view_volunteer')}}" class="box" >
            <div class="box-body text-center">
        ...
        <div class="col-xl-2 col-md-6 col-6">
          <a href="{{url('Admin/sewapartner1')}}" class="box" >
            <div class="box-body text-center">
        ...
        <div class="col-xl-2 col-md-6 col-6">
          <a href="{{url('Admin/viewcardholder')}}" class="box" >
            <div class="box-body text-center">
              <div class="bg-info-light rounded10 p-20 mx-auto w-100 h-100">
        ...
        <div class="col-xl-2 col-md-6 col-6">
          <a href="{{url('Admin/reports')}}" class="box" >
            <div class="box-body text-center">
              <div class="bg-info-light rounded10 p-20 mx-auto w-100 h-100">
      ...
      <div class="row " >
        <div class="col-xl-2 col-md-6 col-6">
          <a  href="{{url('Admin/view_active_cardholder')}}" class="box">
            <div class="box-body text-center">
        ...
        <div class="col-xl-2 col-md-6 col-6">
          <a  href="{{url('Admin/view_deactive_cardholder')}}" class="box" >
            <div class="box-body text-center">
              <div class="bg-danger-light rounded10 p-20 mx-auto w-100 h-100">
        ...
        <div class="col-xl-2 col-md-6 col-6">
          <a  href="{{url('Admin/pending_blood_request')}}" class="box" >
            <div class="box-body text-center">
              <div class="bg-warning-light rounded10 p-20 mx-auto w-100 h-100">
        ...
        <div class="col-xl-2 col-md-6 col-6">
          <a href="{{url('Admin/view_feedback')}}" class="box" >
            <div class="box-body text-center">
              <div class="bg-info-light rounded10 p-20 mx-auto w-100 h-100">
        ...
        <div class="col-xl-2 col-md-6 col-6">
          <a  href="{{url('Admin/pending_business')}}" class="box" >
            <div class="box-body text-center">
              <div class="bg-info-light rounded10 p-20 mx-auto w-100 h-100">
        ...
        <div class="col-xl-2 col-md-6 col-6">
          <a href="{{url('Admin/pending_notifications')}}" class="box">
            <div class="box-body text-center">
              <div class="bg-info-light rounded10 p-20 mx-auto w-100 h-100">

...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css">
  ...
  <style>
    ...
    #carddata{
      ...
      /* background-image: url("../public/images/IMG/Golden-Back-Side-01.jpg") !important; */
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header mb-5">
      <div class="container-fluid">
        <div class="new">
          <div id="cardid">
          <!-- {{$cardholderdetails->id}} -->
          </div>
         
          <div class="card card-primary">
            <img src="{{asset('/public/images/IMG/Golden-Front-Side-01.jpg')}}" style="width:100%;    "> 
            <!-- <h4 style="text-align:center;  background-color:#ED9B2D">Khalsa Card</h4> -->
            <div class="cardholder_class">
               <!-- <b> {{$cardholderdetails->id}} </b> -->
               <b> 1469-{{1000000+$cardholderdetails->id}} </b>
            </div>
            <!-- <img src="{{ asset('/public/images/IMG/card-logo.png') }}" style="width:100%; height:200px;">  -->
          </div>
    ...
    <section class="content mt-5">
      <div class="container-fluid">
        <div class="row">
            ...
            <div id="carddata">
              <!-- /.card-header -->
              <img src="{{asset('/public/images/IMG/Golden-Back-Side-01.jpg')}}" style="width:100%;">

...
<style>
  ...
  @media only screen and (device-width : 375px) and (device-height : 736px) and (-webkit-device-pixel-ratio : 3) {
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                      ...
                      <select name="categories" id="categories" style="width: 100%;height: 37px;">
                        ...
                        <option value="Hospital" {{$sewapartner->categories == "Hospital"  ? 'selected' : ''}}
                          disabled="disabled">Hospital</option>
                        <option value="Clinic" {{$sewapartner->categories == "Clinic"  ? 'selected' : ''}}
                          disabled="disabled">Clinic</option>
                        <option value="Laboratory" {{$sewapartner->categories == "Laboratory"  ? 'selected' : ''}}
                          disabled="disabled">Laboratory</option>
                        <option value="Medicalstore" {{$sewapartner->categories == "Medicalstore"  ? 'selected' : ''}}
                          disabled="disabled">Medical Stores</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-12">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" class="form-control" placeholder="Enter Password" name="password"
                        id="password" value="{{$sewapartner->numpassword}}">
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Enter Address" name="sewa_address"
                        id="sewa_address" value="{{$sewapartner->sewa_address}}">
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-12">
                    {{-- <div class="row">
                    ...
                    <div class="form-group" id="show_services">
                      ...
                      <select class="js-example-basic-multiple" name="services[]" multiple="multiple"
                        style="width: 100%">
                        @foreach($allservices as $service)
                        <option value="{{$service->service}}" @if(in_array($service->service,$services->toArray()))
                          selected @endif>{{$service->service}}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                ...
                <div class="col=lg-6 col-md-6 col-sm-12">
                  <div class="form-group" id="medicaltime">
                    ...
                    <input type="text" class="form-control" placeholder="Timings" name="timings" id="timings"
                      value="{{$sewapartner->timings}}" readonly>
                  </div>
              ...
              <div class="row" id="hospitaltime">
                <div class="col-lg-6 col-md-6 col-sm-12">
                  ...
                  <div class="form-group ">
                    ...
                    <input type="time" class="form-control" value="{{$sewapartner->timings}}" placeholder="Timings"
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                  ...
                  <input type="time" class="form-control" value="{{$sewapartner->timings2}}" placeholder="Timings"
                      name="timings2" id="timings">
                </div>
                      <!-- </div> -->
              </div>
              @endif
...
<script type="text/javascript">
  ...
  $('#sewa-form').on('submit', function(event) {
    ...
    $.ajax({
      type: "POST",
      url: "{{url('Admin/updatesewapartner')}}" + '/' + id,
      dataType: 'json',

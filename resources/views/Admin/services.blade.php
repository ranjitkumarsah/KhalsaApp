                   ...
                   @foreach($services as $service)
                    <tr style="text-align: center;">
                      ...
                      <td >
                        ...
                        <a href="{{url('Admin/deleteservice')}}/{{$service->id}}"><i class="fa-solid fa-trash-can" style="color:red; font-size:23px;margin-left: 3px;" onclick="return confirm('Are you sure to delete this?')"></i></a>

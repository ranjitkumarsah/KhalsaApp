          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="{{url('Admin/view_sewanotifications')}}" class="btn btn-primary" style="float:right;margin-right:12px;">View Notification</a>  --}}
   ...
   <script> 
     ...
     function show(id) {
        //  alert(id);
         $.ajax({
             type: "Get",
             url:"{{url('Admin/change_notification_status')}}",

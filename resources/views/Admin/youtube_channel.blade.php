        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary" style="font-size: 0.9rem;">
                    ...
                    <div class="row">
                      <div class="col=lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="title" placeholder="Enter  Link" name="link" value="{{ $youtube ? $youtube->youtube_link : '' }}">
                        </div> 
                      </div>
                      <div class="col=lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                          ...
                          <img src="{{ $youtube ? $youtube->image : '' }}" style="height:50px;width:50px;" alt="YouTube Image">
                        </div>
                      </div>
                    </div>
			 ...
			 <button type="submit" class="btn btn-primary" style="margin-left: 20px; color:black;">Submit</button>
                     </div>
...
<script type="text/javascript">
  ...
  $('#sub-admin-form').on('submit', function(event){
     ...
     $.ajax({
       type: "POST",
        url: "{{url('Admin/saveyoutube_channel')}}",
        dataType: 'json',

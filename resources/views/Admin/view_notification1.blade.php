        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <!-- /.card-header -->
              <div class="card-body">
                <a href="{{url('Admin/notifications')}}" class="btn btn-primary" style="float:right;">Add Notification</a><br><br> 
                <table id="Table_ID" class="table table-responsive table table-bordered table-hover" >
                  <thead>
                  <tr>
                  ...
                  <tbody>
                    ...
                    <td>{{$notification->category}}</td>      
                      ...
                      <td><img src="{{$notification->image}}" style="height: 50px;width:50px;"></td>
                      ...
                      <td>
                        ...
                        <a href="{{url('Admin/deletenotification',$notification->id)}}"><i class="fa-solid fa-trash-can" style="color:red; font-size:23px;" onclick="return confirm('Are you sure to delete this?')"></i></a>
                      </td>

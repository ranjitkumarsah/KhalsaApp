        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <!-- /.card-header -->
              <div class="card-body">
                <a href="{{url('Admin/doctor')}}" class="btn btn-primary" style="float:right;margin-bottom: 12px;">Add Doctors</a><br><br>
                <table id="Table_ID" class="table table-responsive-sm table table-bordered table-hover" >
                  ...
                  <tbody style="font-size: 0.9rem;">
                    ...
                    <td>{{"DR".$doctor->id}}</td>      
                      ...
                      <td>
                        <a href="{{url('Admin/editdoctor')}}/{{$doctor->id}}"><i class="fa-solid fa-square-pen" style="font-size:25px;"></i>
</a>
                        <a href="{{url('Admin/deletedoctor',$doctor->id)}}"><i class="fa-solid fa-trash-can" style="color:red; font-size:23px;margin-left: 3px;" onclick="return confirm('Are you sure to delete this?')"></i></a>
                      </td>

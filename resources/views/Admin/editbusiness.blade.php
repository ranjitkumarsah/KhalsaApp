        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form id="sub-admin-form">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                          <label for="email">Business Type: <span class="text-danger">*</span></label><br>
			 ...
			 <button type="submit" class="btn btn-primary" style="margin-left: 20px;">Update Business</button>
                     </div>
...
<script type="text/javascript">
  ...
  $('#sub-admin-form').on('submit', function(event){
   ...
   var id = $("#business_id").val();
     $.ajax({
       type: "POST",
        url: "{{url('Admin/updatebusiness')}}" + '/' + id,
        dataType: 'json',

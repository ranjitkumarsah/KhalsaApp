                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row" style="float: right;margin-bottom: 5px;">
                                    <a href="{{url('Admin/add_vacancy')}}" class="btn btn-primary" style="margin-right:10px;height: 36px; font-size: 0.9rem;">Add vacancy</a><br><br>
                                </div>
                                <table id="Table_ID" class="table table-responsive-sm table table-bordered table-hover">
                                    ...
                                    <tbody style="font-size: 0.9rem;">
                                        ...
                                        <tr style="text-align:center">
                                            ...
                                            <td>
                                                <a href="{{url('Admin/edit_vacancy')}}/{{$value->id}}"><i class="fa-solid fa-square-pen" style="font-size:25px;"></i>
                                                </a>
                                                <a href="{{url('Admin/delete_vacancy',$value->id)}}"><i class="fa-solid fa-trash-can" style="color:red; font-size:23px;margin-left:3px;" onclick="return confirm('Are you sure to delete this?')"></i></a>
                                            </td>

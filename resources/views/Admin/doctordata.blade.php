                ...
                <div class="row">
                      <div class="col-lg-6 col-md-4 col-sm-12">
                        <div class="form-group name_class">
                          <label for="email">Select Sewapartner:</label><br>
                           <select name="sewapartner" id="sewapartner" style="width: 100%;height: 37px;">
                      ...
                      <div class="col-lg-6 col-md-4 col-sm-12">
                        <div class="form-group qualification_class">
                          <label for="email">Select Doctor:</label><br>
                          <select name="doctor" id="doctor" style="width: 100%;height: 37px;">
                           <option value="">Select</option>

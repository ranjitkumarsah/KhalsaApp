  ...
  <style>
    ...
    #carddata{
      /* background-color:#ED9B2D; */
        /* background-image: url("../public/images/IMG/Blue-Back-Side-01.jpg") !important; */
      ...
      <div class="container-fluid">
        <div class="new">
          ...
          <div class="card card-primary">
            <img src="{{asset('/public/images/IMG/Blue-Front-Side-01.jpg')}}" style="width:100%;    ">   
            ...
            <div class="cardholder_idclass">
              ...
              <!-- <b> 1984-{{1000000+@$cardholderdetails->id}} </b> -->
            </div>
    ...
    <section class="content mt-5">
      <div class="container-fluid">
        <div class="row">
            ...
            <div id="carddata">
              <!-- /.card-header -->
              <img src="{{asset('/public/images/IMG/Blue-Back-Side-01.jpg')}}" style="width:100%;">
              <div class="card-body second pb-5 ml-5" style="z-index:999; position:absolute; top:0;left:0;">
                ...
                <form>
                  ...
                  <!-- <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">{{--$cardholderdetails->name--}}
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">      {{--$cardholderdetails->address--}}
                    </div>
                  </div><br>

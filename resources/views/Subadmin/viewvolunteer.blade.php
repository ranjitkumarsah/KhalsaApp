          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="col-md-2"></div>
                  <div class="col-md-2">
                    <a href="{{url('Subadmin/volunteer')}}" class="btn btn-primary" style="float:right;margin-top: 32px;">Add Volunteer</a>
                  </div>
              <!-- <a href="{{url('Subadmin/volunteer')}}" class="btn btn-primary" style="float:right;height: 37px;margin-top: 27px;margin-left: 146px;">Add Volunteer</a><br><br> -->
                </div>
...
{{-- <script>
  ...
  <script>
    var table = $('#Table_ID').DataTable({
        ...
        stateSave:true,
        ajax: {
          url: "{{ url('Subadmin/view_volunteer') }}",
          data: function (d) {
  ...
  <script> 
    ...
    function show(id) {
       //  alert(id);
        $.ajax({
            type: "Get",
            url:"{{url('Subadmin/change_volunteer_status')}}",

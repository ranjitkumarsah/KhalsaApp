          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="{{url('Subadmin/view_sewanotifications')}}" class="btn btn-primary" style="float:right;margin-right:12px;">Pending Notification</a> 
                <table id="Table_ID" class="table table-responsive-sm table table-bordered table-hover" >
                  ...
                  <tbody style="font-size: 1.4rem;">
                    ...
                    <td>{{$notification->category}}</td>      
                      ...
                      <td>
                        <a href="{{url('Subadmin/editnotification')}}/{{$notification->id}}"><i class="fa-solid fa-square-pen" style="font-size:25px;"></i>
                        </a>
                        <a href="{{url('Subadmin/deletenotification',$notification->id)}}"><i class="fa-solid fa-trash-can" style="color:red; font-size:23px;margin-left: 3px;" onclick="return confirm('Are you sure to delete this?')"></i></a>
                      </td>

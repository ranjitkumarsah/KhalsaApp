<html>
  <head>
    <style>
      body{
          background-image: url("/public/images/543.jpg");
...
<body>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8 offset-md-2 sign_class">
          ...
          <form method="POST" action="{{url('Subadmin/subadmindata')}}">
    @csrf
    ...
    @endif
    <h4 style="text-align:center;" class="admin_login">Sub-Admin Login</h4>

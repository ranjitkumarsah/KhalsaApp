    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <a href="{{url('Subadmin/view_doctor')}}" class="btn btn-primary back_btn">Back</a>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary" style="font-size: 0.9rem">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/Subadmin/savedoctor" method="POST" enctype="multipart/form-data" id="form">
                @csrf
                <div class="card-body">
                <div class="row">
                      <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="form-group name_class">
                          ...
                          <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name"  placeholder="Enter enter name">
                          @error('name')
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="form-group qualification_class">
                          ...
                          <input type="text" name="qualification" class="form-control @error('qualification') is-invalid @enderror" id="qualification" placeholder="Enter qulaification" >
                          @error('qualification')
                          <span class="invalid-feedback" role="alert">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" name="specialization" class="form-control @error('specialization') is-invalid @enderror" id="specialization" placeholder="Enter specialization">

...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="admin_section mt-2">
      <p class="admin_para">Sub-Admin</p>
      <p class="admin_para" style="margin-top: -22px;">({{Auth::guard("subadmin")->user()->name}})</p>
    </div>
    <hr>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item @yield('dashboard')">
            <a href="{{url('Subadmin/dashboard')}}" class="nav-link @yield('dashboard_item')">
          ...
          <li class="nav-item @yield('reports')">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('Subadmin/reports')}}" class="nav-link @yield('addreports')">
                  <i class="far fa-circle nav-icon" style="margin-left: 30px;color:white;"></i>
                  <p class="paracolor">View Invoice</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('Subadmin/invoices')}}" class="nav-link @yield('addinvoices')">
          ...
          <li class="new">
            <a href="{{url('Subadmin/sewapartner')}}"  class="nav-link @yield('viewsewapartner')">
        ...
        <li class="new">
            <a href="{{url('Subadmin/view_doctor')}}"  class="nav-link @yield('viewdoctor')">
        ...
        <li class="new">
            <a href="{{url('Subadmin/services')}}"  class="nav-link @yield('viewservices')">
        ...
        <li class="new">
            <a href="{{url('Subadmin/view_volunteer')}}"  class="nav-link @yield('viewvolunteer')">
            ...
            <li class="new">
            <a href="{{url('Subadmin/viewcardholder')}}"  class="nav-link @yield('viewcardholder')">
        ...
        <li class="new">
            <a href="{{url('Subadmin/view_notifications')}}"  class="nav-link @yield('view_notifications')">
        ...
        {{-- <li class="new">
          <a href="{{url('Subadmin/viewkhalsamember')}}"  class="nav-link @yield('viewkhalsamember')">
          <i class='far fa-address-card new' style='font-size:16px;'></i>
            <p style="margin-left: 10px;" class="paracolor">
        ...
        <li class="new">
          <a href="{{url('Subadmin/view_business')}}"  class="nav-link @yield('view_business')">
      ...
      <li class="new">
          <a href="{{url('Subadmin/vacancies')}}"  class="nav-link @yield('vacancies')">
          <i class="fas fa-business-time" style="font-size:14px;"></i> 
            <p style="margin-left: 10px;" class="paracolor">
               Manage Vacancies
              <i class="right fas fa-angle-left"></i>
      ...
      <li class="new">
        <a href="{{url('Subadmin/view_feedback')}}"  class="nav-link ">
    ...
    <li class="new">
      <a href="{{url('Subadmin/blood_donor')}}"  class="nav-link ">
  ...
  <li class="new">
    <a href="{{url('Subadmin/blood_request')}}"  class="nav-link ">
    <i class="	fa fa-heartbeat" style="font-size:13px;"></i> 
      <p style="margin-left: 10px;" class="paracolor">
  ...
  <li class="new">
    <a href="{{url('Subadmin/youtube_channel')}}"  class="nav-link ">
  ...
  <li class="new">
    <a href="{{url('Subadmin/support_number')}}"  class="nav-link ">
  ...
  <li class="new">
    <a href="{{url('Subadmin/khalsa_pariwar_link')}}"  class="nav-link ">
...
<a href="{{url('Subadmin/about')}}"  class="nav-link ">
  ...
  <p style="margin-left: 10px;" class="paracolor">
    ...
    <!-- <i class="right fas fa-angle-left"></i> -->
        ...
        <li class="new">
            ...
            <a href="{{url('Subadmin/logout')}}"  class="nav-link ">

            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="row fdhjgd">
                  ...
                  <div>
                    <a href="{{url('Subadmin/doctor_invoice')}}" class="btn btn-primary" style="margin-right:13px;">Doctors</a><br><br>

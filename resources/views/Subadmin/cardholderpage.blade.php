      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          @if($datas->is_needy == 'Yes')
              <a href="{{url('Subadmin/khalsamemberformdata',$datas->id)}}" class="btn btn-success mr-4" style="font-size: 0.9rem;">Download Card</a>
            @else 
              <a href="{{url('Subadmin/khalsaformdata',$datas->id)}}" class="btn btn-success mr-4" style="font-size: 0.9rem;">Download Card</a>
            @endif
            <a href="{{url('Subadmin/viewcardholder')}}"class="btn btn-primary"  style="position: relative !important;  background-color:#ED9B2D; color:black;" style="font-size: 0.9rem;">Back</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                    ...
                    <div class="row">
                      <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="row">
                          ...
                          <div class="col-5">
                              <p> : &emsp;{{$is_needy_data->name }}</p>
                              <p> : &emsp;{{$is_needy_data->disease_time}}</p>
                              <p> : &emsp;{{$is_needy_data->medical_detail}}</p>
                              <p> : &emsp;{{$is_needy_data->foundation_detail}}</p>
                              <p> : &emsp;{{$is_needy_data->foundation_help}}</p>
                              <p> : &emsp;{{$is_needy_data->foundation_member}}</p>
                              <p> : &emsp;{{$is_needy_data->govthelp}}</p>
                              <p> : &emsp;{{$is_needy_data->help_amount}}</p>
                              <p> : &emsp;{{$is_needy_data->agriculture}}</p>
                              <p> : &emsp;{{$is_needy_data->social_media}}</p>
                          </div>
                        </div>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="row">
                          ...
                          <!-- <h3>Volunteer Signature</h3> -->
                          </div>
                          <div class="col-5">
                            <p> : &emsp;{{$is_needy_data->gurudwara}}</p>
                            <p> : &emsp;{{$is_needy_data->gurudwara_mgmt}}</p>
                            <p> : &emsp;{{$is_needy_data->gurudwara_contact}}</p>
                            <p> : &emsp;{{$is_needy_data->attesting_officer}}</p>
                            <p> : &emsp;{{$is_needy_data->family_head}}</p>
                            <p> : &emsp;{{$is_needy_data->volunteer_name}}</p>
                            <p> : &emsp;{{$is_needy_data->two_wheeler}}</p>
                            <p> : &emsp;{{$is_needy_data->four_wheeler}}</p>
                            <p> : &emsp;{{$is_needy_data->air_conditioner}}</p>
                            <p> : &emsp;{{$is_needy_data->income_source}}</p>
                            <!-- <p> : &emsp;{{$is_needy_data->volunteer_signature}}</p> -->
                          </div>
                        </div>

...
<style>
 ...
 <div id="textboxcont"></div>
			   ...
			   <div class="form-group">
                  	  ...
                  	  <input type="number" class="form-control"  placeholder="Enter Contact Number" name="contactnumber" id="contactnumber">
                      </div>
		      </div>
		  </div>
		...
		{{-- <div class="row">
                  ...
                  <div class="row" id="hospitaltime" style="display: none;">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                      <div class="form-group">
                        ...
                        <input type="time" class="form-control" onchange="onTimeChange()"  placeholder="Timings" name="timings" id="timings" >
                      </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                      <div class="form-group">
                        <label for="email">Timings To:</label>
                        <input type="time" class="form-control" onchange="onTimeChange()"  placeholder="Timings" name="timings2" id="timings2">
                      </div>
                    </div>
                  </div>
		 ...
		 <div class="row">
			...
			<div class="form-group" style="display: none;" id="medicaltime">
                    	...
                    	<input type="text" class="form-control"  placeholder="24 * 7" name="clinictimings" id="timings">
                  	</div>
                	</div>
		</div>
                    <div class="row">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <input type="file" name="profile" class="form-control" id="profile_pic" >
                    ...
                    <select class="form-control js-example-basic-multiple" name="services[]" multiple="multiple" style="width: 100%" >
...
<script type="text/javascript">
  ...
  $('#sewa-form').on('submit', function(event){
    // alert('hh');
     ...
     $.ajax({
       type: "POST",
        url: "{{url('Subadmin/addsewapartnersform')}}",
        dataType: 'json',

        ...
        <div class="row justify-content-center"> 
          ...
          <div class=" col-lg-12 col-md-12">
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-12">
                <div class=" form-group">
                  <input type="text" class="form-control" name="verify_officer" id="verify_officer" value="{{$cardholder->verify_officer}}" placeholder="Enter verifying officer name">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#form').on('submit', function (e) {
      ...
      $.ajax({
          type: 'POST',
          url: '{{url('Subadmin/updatecardholder')}}' + '/' + id,
          dataType: 'json',
          data: data,  
          cache: false,
          contentType: false,

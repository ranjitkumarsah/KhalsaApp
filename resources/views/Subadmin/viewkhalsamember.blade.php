            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="table-responsive"> 
                  {{-- <a href="{{url('Subadmin/cardholder')}}" class="btn btn-primary" style="float:right;">Add CardHolder</a><br><br> --}}
                  <a href="{{url('Subadmin/newcardholder')}}" class="btn btn-primary" style="float:right;">Add Khalsa Member</a><br><br>
                        ...
                        @if($member->active_status == 1 )
                         ...
                         <button class="on" id="inactive" onclick="show({{$member->id}})"><i class="fa-solid fa-toggle-off"></i></button>
                            ...
                            <td>  
                              ...
                              <td>
                                {{-- <a href="{{url('Subadmin/editcardholder')}}/{{$cardholders->id}}"><i class="fa-solid fa-square-pen" style="font-size:25px;"></i></a> --}}
                                <a href="{{url('Subadmin/deletemember',$member->id)}}"><i class="fa-solid fa-trash-can" style="color:red; font-size:23px;" onclick="return confirm('Are you sure to delete this?')"></i></a>
                              </td>         
   ...
   <script> 
     ...
     function show(id) {
        //  alert(id);
         $.ajax({
             type: "Get",
             url:"{{url('Subadmin/khalsa_active_status')}}",
             data: {member_id:id },
     ...
     <script> 
      ...
      function verify(id) {
         //  alert(id);
          $.ajax({
              type: "Get",
              url:"{{url('Subadmin/khalsa_verify_status')}}",
              data: {member_id:id },
              success: function(data) {              
                    location.reload();
              }

                ...
                <div class="row">         
                  ...
                  <div class="col-md-3 category_class" style="position: relative;top: 20px;">
                    ...
                    <select data-coloum="0" class="form-control filter-select" name="category" id="category">
		              ...
		              <a href="{{url('Subadmin/register')}}" class="btn btn-primary" style="float:right;position: relative;bottom: 20px;">Add Sewapartner</a><br><br>
  ...
  <script> 
    ...
    function show(id) {
       //  alert(id);
        $.ajax({
            type: "Get",
            url:"{{url('Subadmin/change_sewapartner_status')}}",

              ...
              <form action="/Subadmin/saveservices" method="POST" enctype="multipart/form-data" id="form">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input  type="text" name="business_type" class="form-control @error('business_type') is-invalid @enderror" id="service" placeholder="Enter Business_type" required>
                    @error('business_type')
                   ...
                   @foreach($business as $value)
                    <tr>
                      ...
                      <td >
                        ...
                        <a href="{{url('Subadmin/deletebusiness_type')}}/{{$value->id}}"><i class="fa-solid fa-trash-can" style="color:red; font-size:23px;" onclick="return confirm('Are you sure to delete this?')"></i></a>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    var data = new FormData(this);
      ...
      $.ajax({
          type: 'POST',
          url: '{{url('Subadmin/savebusiness_type')}}',
          dataType: 'json',
          data: data,  
          cache: false,
          contentType: false,

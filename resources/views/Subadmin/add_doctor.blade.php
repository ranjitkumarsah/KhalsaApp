    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-2">
            <a href="{{url('Subadmin/sewadetails')}}/{{$id}}" class="btn btn-primary float-right back_btn">Back</a>
          </div>
          <div class="col-sm-6">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    // console.log(data);
      ...
      $.ajax({
          type: 'POST',
          url: '{{url('Subadmin/saveadd_doctor')}}' + '/' + id,
          dataType: 'json',
          data: data,
...
<script>
  ...
  $('#name').change(function(){
    ...
    $.ajax({
      type: 'GET',
      url: '{{url('Subadmin/check_time_schedule')}}' + '/' + doctor_id,     
      success: function (data) {

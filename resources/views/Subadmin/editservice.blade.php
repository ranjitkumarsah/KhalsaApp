    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
              <a href="{{url('Subadmin/services')}}" class="btn btn-primary back_btn">Back</a>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary" style="font-size: 0.9rem;">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/Subadmin/updateservice" method="POST" enctype="multipart/form-data" id="form">
                @csrf
                <div class="card-body">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    id = $("#service_id").val();
      $.ajax({
          type: 'POST',
          url: '{{url('Subadmin/updateservice')}}' + '/' + id,
          dataType: 'json',
          data: data,  
          cache: false,
          contentType: false,

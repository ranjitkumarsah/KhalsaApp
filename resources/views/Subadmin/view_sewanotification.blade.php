        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            @if($segment == 'pending_notifications') 
              <h1 id="notification_heading">Pending Notifications</h1>
            @else 
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                {{-- <a href="{{url('Subadmin/notifications')}}" class="btn btn-primary" style="float:right;margin-bottom:12px;">Add Notification</a> 
                <a href="{{url('Subadmin/view_sewanotifications')}}" class="btn btn-primary" style="float:right;margin-right:12px;">View Notification</a>  --}}
                <table id="Table_ID" class="table table-responsive-sm table table-bordered table-hover" >
                  <thead>
                  <tr>
                    <th style="width: 15px;">#</th>
                    <th style="width: 15px;">Sewapartner Name</th>    
                  ...
                  <tbody style="font-size: 1.4rem;">
                    ...
                    <td>{{$id++}}</td> 
                    <td>{{$notification->sewapartner_name}}</td> 
                      ...
                      <div id="show_image_popup">
                        ...
                        <td>  
                          @if($notification->status == 1 )
                           <button class="on" id="active" onclick="show({{$notification->id}})"><i class="fa-solid fa-toggle-on" ></i></button>
                           @else
                           <button class="on" id="inactive" onclick="show({{$notification->id}})"><i class="fa-solid fa-toggle-off"></i></button>
                              @endif
   ...
   <script> 
     ...
     function show(id) {
        //  alert(id);
         $.ajax({
             type: "Get",
             url:"{{url('Subadmin/change_notification_status')}}",

        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary" style="font-size: 0.9rem;">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/SubAdmin/savevolunteer" method="POST" enctype="multipart/form-data" id="form">
                @csrf
                <div class="card-body">
                <div class="row">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="form-group">
                      <label for="name">Username</u></label>
                ...
                <div class="row">
                  <div class="col=lg-6 col-md-6 col-sm-12">
                    <div class="form-group">
                      ...
                      <input type="file" name="vote_card" class="form-control @error('vote_card') is-invalid @enderror" id="vote_card" >
                      @error('vote_card')
                      <span class="invalid-feedback" role="alert">
                  ...
                  <div class="col=lg-6 col-md-6 col-sm-12">
                    ...
                    <input type="file" name="profile_pic" class="form-control @error('profile_pic') is-invalid @enderror" id="profile_pic" >
                    @error('profile_pic')
                    <span class="invalid-feedback" role="alert">
                ...
                <div class="row">
                  <div class="col-lg-3 col-md-3 col-sm-12">
                    ...
                    <input type="file" name="aadhaar_card_front" class="form-control @error('aadhaar_card_front') is-invalid @enderror" id="aadhaar_card_front" >
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-12">
                    ...
                    <input type="file" name="aadhaar_card_back" class="form-control @error('aadhaar_card_back') is-invalid @enderror" id="aadhaar_card_back" >
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    var data = new FormData(this);
      ...
      $.ajax({
          type: 'POST',
          url: '{{url('Subadmin/savevolunteer')}}',
          dataType: 'json',
          data: data,  
          cache: false,
          contentType: false,

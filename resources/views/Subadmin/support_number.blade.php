...
@section('support_number','menu-open')
@section('support_number','active')
                    ...
                    <div class="row">
                      <div class="col=lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="title" placeholder="Enter  Phone Number" name="phone_number" value="{{@$support->phone_number}}">
                        </div> 
                      </div>
...
<script type="text/javascript">
  ...
  $('#sub-admin-form').on('submit', function(event){
     ...
     $.ajax({
       type: "POST",
        url: "{{url('Subadmin/savesupport_number')}}",
        dataType: 'json',

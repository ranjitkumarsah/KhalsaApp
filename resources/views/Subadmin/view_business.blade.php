          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="{{url('Subadmin/business')}}" class="btn btn-primary" style="margin-right:10px;height: 36px;
                font-size: 0.9rem;">Add Business</a><br><br>
                <a href="{{url('Subadmin/business_type')}}" class="btn btn-primary" style="height: 36px;
                      ...
                      <td>  
                        @if($value->status == 1 )
                         ...
                         <button class="on" id="inactive" onclick="show({{$value->id}})"><i class="fa-solid fa-toggle-off"></i></button>
                            ...
                            <td>
                              <a href="{{url('Subadmin/editbusiness')}}/{{$value->id}}"><i class="fa-solid fa-square-pen" style="font-size:25px;"></i>
                              </a>
                              <a href="{{url('Subadmin/deletebusiness',$value->id)}}"><i class="fa-solid fa-trash-can" style="color:red; font-size:23px;margin-left:3px;" onclick="return confirm('Are you sure to delete this?')"></i></a>
                            </td>

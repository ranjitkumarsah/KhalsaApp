...
.profile-info, .business-info {
  ...
  <div class="content-wrapper" style="">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-3" style="display: flex;justify-content: flex-end;">
            @if($data->categories == "Hospital")
              <a href="{{url('Subadmin/add_doctor')}}/{{$data->id}}" class="btn btn-primary float-right mr-5">Add Doctor</a>
            @endif
            <a href="{{url('Subadmin/sewapartner')}}"class="btn btn-primary back_btn float-right">Back</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <!-- Main content -->
    <section class="content first-section pb-5">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
                ...
                <table class="table mt-5 mb-4">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <span>{{$data->timings}}</span>&emsp;&emsp;
                      <span>{{$data->timings2}}</span>
                    </td>
                    @endif
                  </tr>
                </table>
              ...
              <?php $i=1; ?>
               @foreach($doctors as $doctor)
                <tr>
                  ...
                  <td>
                    {{-- <a href="{{url('Subadmin/editservice')}}/{{$service->id}}"><i class="material-icons">edit</i></a> --}}
                    <a href="{{url('Subadmin/deletesewa_doctor')}}/{{$doctor->id}}"><i class="material-icons" onclick="return confirm('Are you sure to delete this?')">delete</i></a>
...
@if($data->categories == "Hospital")
<script>
  $('.first-section').removeClass('pb-5');
</script>
@endif
@endsection
<!-- AdminLTE App -->

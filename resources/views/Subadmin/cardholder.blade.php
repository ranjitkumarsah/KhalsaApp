          ...
          <div class=" col-lg-12 col-md-12">
            <form  method="post" action="{{url('Subadmin/savecardholder')}}" id="form">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="username" placeholder="Enter head of the family name" name="name">
                      </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                      <div class="form-group">
                        <label for="pwd">ਪਰਿਵਾਰ ਦੇ ਮੁਖੀ</label>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                      <div class="form-group">
                        ...
                        <input type="number" placeholder="Enter contact number" class="form-control" name="contact_number" id="contact_nos" maxlength="10">
                      </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                      <div class="form-group">
                        <label for="whatsapp_number">WhatsApp Number</label>
                        <input type="number" placeholder="Enter WhatsApp Number" class="form-control" name="whatsapp_number" id="whatsapp_number" maxlength="10">
                      </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                      <div class="form-group">
                    ...
                    <div class="row mt-3 mx-2 family-details">
                        ...
                        <div class="col-lg-2 col-sm-12">
                          <div class="form-group">
                            ...
                            <input type="text" name="faadhaar[]" placeholder="Enter Aadhaar No" onkeypress="return isNumber(event)" maxlength="12"   class="form-control"> 
                          </div>
                    ...
                    <div class="row mt-3 mx-2 children-details">
                      ...
                      <div class="col-lg-2 col-sm-12 ">
                        <div class="form-group">
                          ...
                          <input type="number" name="cfees[]" placeholder="Enter fees amount" class="form-control" >
                        </div>
                      </div>
                      <div class="col-lg-2 col-sm-12 ">
                        <div class="form-group">
                          <label for="cschool">School Name</label>
                          <input type="text" name="cschool[]" placeholder="Enter school name"  class="form-control">
                        </div>
                      </div>
                      <div class="col-lg-2 col-sm-12 ">
                        <div class="form-group">
                          <label for="caadhaar">Aadhaar Card No</label>
                          <input type="text" name="caadhaar[]" placeholder="Enter Aadhaar No"  onkeypress="return isNumber(event)" maxlength="12" class="form-control">
                        </div>
                      </div>
                      <div class="col-lg-2 col-sm-12">
                        <div class="form-group">
              ...
              <div class="row mt-3" style="font-size: 0.9rem;">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                  <div class=" form-group " >
                    <input type="text" class="form-control" placeholder="Enter verifying officer name" name="verify_officer" id="verify_officer" >
...
<script type="text/javascript">
  $( document ).ready(function() {
    ...
    var spinner = $('#loader');
      ...
      $.ajax({
          type: 'POST',
          url: '{{url('Subadmin/savecardholder')}}',
          dataType: 'json',
          data: data,  
          cache: false,
          contentType: false,

...
class SubAdminController extends Controller
{
    public function addsubadmin(){
        return view('Subadmin.Auth.addsubadmin');
    }


    public function substoreToken(Request $request){
      $token = $request->token ?  $request->token : '';
      DB::table('subadmins')->where('id',Auth::guard('subadmin')->user()->id)->update(['web_token'=>$token]);
      return 1;
    ...
    public function subadmin_login(){
        return view('Subadmin.Auth.subadminloginfile');
    }

    public function  subadminlogincheck(Request $request){
        $validator = Validator::make($request->all(), [
            'email'              =>     'required',
            'password'           =>     'required', 
        ]);
        if($validator->fails())
            {
            return redirect('Subadmin/login')->withErrors($validator);     
            }
          $cres = $request->only('email','password');
           if(Auth::guard('subadmin')->attempt($cres)){
            if(Auth::guard('subadmin')->user()->active_status == 1){
              return redirect('Subadmin/dashboard');
            }else{
              return redirect('Subadmin/login')->with('errormessage', 'Your Account Is Not Active');
            }
            
           }
           else{
            return redirect('Subadmin/login')->with('errormessage', 'Please Enter Valid Credentials!');
           }
    }
    ...
    public function subadmin_dashboard()
    {
     ...
     //  dd($discount);
      ...
      return view('Subadmin.dashboard',compact('active_cardholder','deactive_cardholder','pending_blood','feedback','pending_business','pending_notification','blood','fruit_count','veg_count','grains_count','volunteers','sewapartners','subadmin','cardholder','doctor','hospital','clinic','laboratory','medicalstore','data','volunt','discount','invoices'));
  }
  public function cardholder()
  {
    $cities = DB::table('cities')->get();
    return view('Subadmin.cardholder',compact('cities'));
  }
  ...
  public function volunteer()
  {
    ...
    return view('Subadmin.volunteer',compact('volunteers','cities'));
  ...
  public function savevolunteer(Request $request)
  {
   ...
   $validator = Validator::make($request->all(), [ 
    ...
    //   $sewapartners = DB::table('sewapartners')->get();
    //  //  dd($sewapartners);
    //   return view('Subadmin.sewapartner',compact('sewapartners')); 
    // }
      ...
      // dd($data);
            return Datatables::of($sewapartners)
              ...
              ->addColumn('name', function($row){
                $name='<a href="'.url("Subadmin/sewadetails").'/'.$row->id.'">'.$row->name.'</a>';
                return $name;
            })
              ...
              ->addColumn('badge', function($row){
                ...
                ->addColumn('action', function($row){
                    $actionBtn = '<a href="'.url("Subadmin/editsewapartner").'/'.$row->id.'"><i class="fa-solid fa-square-pen" style="font-size:25px;margin-right: 3px;"></i></a>';
                    $actionBtn .= '<a href="'.url("Subadmin/deletesewapartner").'/'.$row->id.'"><i class="fa-solid fa-trash-can" style="color:red; font-size:23px;" onclick="return confirm(`Are you sure to delete this?`)"></i></a>'; 
          ...
          return view('Subadmin.sewapartner',compact('services'));
      
        
  }
    // public function viewcardholder(){
    //   $cardholderdata = DB::table('cardholder')->get();
    //   return view('Subadmin.view_cardhholder',compact('cardholderdata'));     
    //  }
  ...
  public function viewcardholder(Request $request)
  {
   ...
   if ($request->ajax()) {
     ...
     ->addColumn('name', function($row){
       $name='<a href="'.url("Subadmin/carddata").'/'.$row->id.'">'.$row->name."($row->age yrs)".'</a>';
       return $name;
     })
     ...
     ->addColumn('action', function($row){
       $actionBtn = '<a href="'.url("Subadmin/editcardholder").'/'.$row->id.'"><i class="fa-solid fa-square-pen" style="font-size:25px;"></i></a>';
       $actionBtn .= '<a href="'.url("Subadmin/deletecardholder").'/'.$row->id.'"><i class="fa-solid fa-trash-can" style="color:red; font-size:23px;margin-left: 6px;" onclick="return confirm(`Are you sure to delete this?`)" ></i></a>';
       
       return $actionBtn;
           
     })
     ->addColumn('family', function($row){
       $family ='<a href="'.url("Subadmin/family_details").'/'.$row->id.'">Family Details</a>';
       return $family;
     })
     ->addColumn('children', function($row){               
       $children ='<a href="'.url("Subadmin/children_details").'/'.$row->id.'">Children Details</a>';
       return $children;
     })
     ->addColumn('download_pdf', function($row){  
       if($row->is_needy == 'No') {
         $download_pdf ='<a href="'.url("Subadmin/khalsaformdata").'/'.$row->id.'">Download Card</a>';
       } else {
         $download_pdf ='<a href="'.url("Subadmin/khalsamemberformdata").'/'.$row->id.'">Download Card</a>';
       }              
       return $download_pdf;  
     })
   ...
   return view('Subadmin.view_cardhholder');
  ...
  public function editbusiness($id)
  {
   ...
   return view('Subadmin.editbusiness',compact('business','cities','business_type'));
  }
 ...
 public function deletebusiness($id)
 {
  ...
  public function view_deactive_cardholder(Request $request){
    ...
    return view('Subadmin.view_cardhholder');
     ...
     public function family_details($id){
      ...
      return view('Subadmin.view_familydetails',compact('familydata','id'));     
     }
     ...
     public function children_details($id){
      ...
      return view('Subadmin.view_childrendetails',compact('childrendata','id'));     
     }
    public function addsewapartner(){
      $services = DB::table('services')->get();
      $doctors = DB::table('doctors')->get();
      $cities = DB::table('cities')->get();
      return view('Subadmin.addsewapartners',compact('doctors','services','cities'));
    }
    ...
    if ($request->ajax()) {
      // dd($order_details);
            return Datatables::of($volunteers)
              ...
              ->addColumn('name', function($row){
                $name='<a href="'.url("Subadmin/volunteerdata").'/'.$row->id.'">'.$row->name.'</a>';
                return $name;
            })
              ...
              ->addColumn('download_pdf', function($row){               
                $download_pdf ='<a href="'.url("Subadmin/khalsacarddata").'/'.$row->id.'">Download Card</a>';
                return $download_pdf;
               
            })
          
                ->addColumn('action', function($row){
                    $actionBtn = '<a href="'.url("Subadmin/editvolunteer").'/'.$row->id.'"><i class="fa-solid fa-square-pen" style="font-size:25px;"></i></a>';
                    $actionBtn .= '<a href="'.url("Subadmin/deletevolunteer").'/'.$row->id.'"><i class="fa-solid fa-trash-can" style="color:red; font-size:23px;" onclick="return confirm(`Are you sure to delete this?`)" ></i></a>';
          ...
          return view('Subadmin.viewvolunteer');
  ...
  public function editvolunteer($id)
  {
    ...
    $cities = DB::table('cities')->get();
    return view('Subadmin.editvolunteer',compact('volunteer','cities'));
  }
  ...
  //  $data = explode(',',$request->days);
   ...
   public function view_doctor()
   {
    ...
    return view('Subadmin.viewdoctor',compact('doctors'));
   }
   public function editdoctor($id)
   {
      $doctor = DB::table('doctors')->where('id',$id)->first();
      $doctor->days = explode(',',$doctor->days);
      return view('Subadmin.editdoctor',compact('doctor'));
   }
  ...
  $data = DB::table('doctors')->where('id',$id)->update($doctor);
   ...
   {
    $services = DB::table('services')->get();
    return view('Subadmin.services',compact('services'));
   }
   ...
   public function editsewapartner($id)
   {
    ...
    // dd($sewapartner);
    $cities = DB::table('cities')->get();
    return view('Subadmin.editsewapartner',compact('doctors','alldoctors','services','allservices','sewapartner','cities'));
   }
  ...
  public function viewsewapartnersdatas($id){
    ...
    return view('Subadmin.sewapartnerpage',compact('data','doctors','services','get_profile','content','service_names'));
   }
   public function doctordata()
   {
     $sewapartner = DB::table('sewapartners')->where('categories','Hospital')->get();
     $doctors = DB::table('doctors')->get();
     return view('Subadmin.doctordata',compact('sewapartner','doctors'));
   }
   ...
   public function add_doctor($id)
   {
     ...
     // dd($doctor_name->name);
     return view('Subadmin.add_doctor',compact('id','doctors','get_name'));
   }
   ...
   public function check_time_schedule($doctor_id) {
    ...
    public function viewvolunteerdatas($id){
      ...
      return view('Subadmin.volunteerpage',compact('datas','name','email','contact_number','address','profile','aadhaar_card_front','aadhaar_card_back','voter_card'));
    }
     public function notifications()
     {
      $cities=DB::table('cities')->get();

      return view('Subadmin.notification',compact('cities'));
    }
  ...
  public function view_sewanotifications()
  {
    ...
    return view('Subadmin.view_sewanotification',compact('notifications'));
  }

     public function view_notifications()
     {
       $notifications = DB::table('notifications')->get();
       return view('Subadmin.view_notification',compact('notifications'));
     }
    ...
    public function editnotification($id)
    {
      ...
      return view('Subadmin.editnotification',compact('notification','cities'));
    }
    public  function updatenotification(Request $request,$id){
     ...
     public function cardholderdatas($id){
      ...
      return view('Subadmin.cardholderpage',compact('datas','datasss','children','is_needy_data','house_images','aadhaar_images'));
    }
    public function editcardholder($id)
   {
    ...
    // dd($cardholder);
    $cities = DB::table('cities')->get();
    return view('Subadmin.editcardholder',compact('cardholder','cities'));
   }
  public function updatecardholder(Request $request,$id)
  {
   ...
   public function edit_is_needy($id)
   {
     ...
     return view('Subadmin.edit_is_needy',compact('data','cardholder_id','house_images','aadhaar_images'));
   }
   ...
   {     
     return view('Subadmin.add_cardfamily',compact('id'));
   }
  ...
  {     
    return view('Subadmin.add_cardchildren',compact('id'));
  }
 ...
 public function editcardholderfamily($id)
 {
  ...
  return view('Subadmin.editcardholderfamily',compact('card_family'));
 }
 public function updatecardholderfamily(Request $request,$id)
 {
  ...
  public function editcardholderchild($id)
  {
   ...
   return view('Subadmin.editcardholderchild',compact('card_child'));
  }
  ...
  public function view_business(Request $request)
  {
    ...
    return view('Subadmin.view_business',compact('business'));
  }
  ...
  public function business()
  {
    $business_type = DB::table('business_types')->orderby('id','desc')->get();
    $cities = DB::table('cities')->select('id','city')->get();
    return view('Subadmin.business',compact('business_type','cities'));
  }
  ...
  public function business_type()
  {
   ...
   return view('Subadmin.business_type',compact('business'));
  }
  ...
  public function view_feedback()
  {
    ...
    return view('Subadmin.view_feedback',compact('feedback'));
  }
  ...
  public function blood_donor(Request $request)
  {
    ...
    if ($request->ajax()) {
      // dd($carholders);
          ...
          return view('Subadmin.blood_donor');
  ...
  public function blood_request(Request $request)
  {
    ...
    if ($request->ajax()) {
      ...
      // ->addColumn('action', function($row){
      //     $actionBtn = '<a href="'.url("Subadmin/editsewapartner").'/'.$row->id.'"><i class="fa-solid fa-square-pen" style="font-size:25px;"></i></a>';
      //     $actionBtn .= '<a href="'.url("Subadmin/deletesewapartner").'/'.$row->id.'"><i class="material-icons" onclick="return confirm("Are you sure to delete this?")" style="position: relative;">delete</i></a>';
    ...
    return view('Subadmin.blood_request');
  ...
  public function blood_status(Request $request)
   ...
   public function viewkhalsamember()
   {
    ...
    return view('Subadmin.viewkhalsamember',compact('members'));
   }
   public function youtube_channel()
   {
    $youtube = DB::table('youtube_channel')->first();
    return view('Subadmin.youtube_channel',compact('youtube'));
   }
      ...
      // dd($order_details);
            ...
            ->addColumn('charges', function($row){
             ...
             ->addColumn('details', function($row){
              $details = '<a href="'.url("Subadmin/invoice_details").'/'.$row->sewapartner_id.'">Details';
          ...
          return view('Subadmin.invoices');
      
       
  }
  public function invoice_details($id)
  {
    $invoices = DB::table('sewapartner_account')->where('sewapartner_id',$id)->orderBy('id','desc')->get();
    ...
    return view('Subadmin.invoice_details',compact('invoices','data'));
  }
  public function doctor_invoice()
  {
    ...
    // $data = DB::table('sewapartner_account')->where('sewapartner_id',$id)->first();
    // $data->sewapartner_name = DB::table('sewapartners')->where('id',$id)->value('name');
    return view('Subadmin.invoice_doctor',compact('invoices'));
  }
  public function doctorinvoice_details($id,$name)
  {
    ...
    // dd($data);
    return view('Subadmin.doctorinvoice_details',compact('data','name'));
  }
  public function volunteerkhalsacard($id){
    $cardholderdetails = DB::table('volunteers')->where('id',$id)->first();
    // $pdf = PDF::loadView('Subadmin.volunteerkhalsacard', ['cardholderdetails' => $cardholderdetails]);
    // return $pdf->download('khalsacard.pdf');
    return view('Subadmin.volunteerkhalsacard',compact('cardholderdetails'));
   }
   public function viewkhalsadatas($id){
    ...
    // $pdf = PDF::loadView('Subadmin.khalsacard', ['cardholderdetails' => $cardholderdetails]);
    ...
    // $response->header('Content-Disposition', 'attachment; filename="khalsacard.pdf"');
     // return $response;
    return view('Subadmin.khalsacard',compact('cardholderdetails'));
  ...
  public function viewkhalsamemberdatas($id){
    ...
    // $pdf = PDF::loadView('Subadmin.khalsamembercard', ['cardholderdetails' => $cardholderdetails]);
    // return $pdf->download('khalsacard.pdf');
    return view('subadmin.khalsamembercard',compact('cardholderdetails'));
  }
   public function support_number()
   {
    $support = DB::table('supports')->first();
    return view('Subadmin.support_number',compact('support'));
   }
  ...
  public function khalsa_pariwar_link()
  {
   ...
   return view('Subadmin.khalsa_pariwar_link',compact('khalsa_pariwar_link'));
  }
  public  function savekhalsa_pariwar_link(Request $request){
    ...
    public function vacancies(Request $request) {
      ...
      return view('Subadmin.vacancies',compact('vacancies'));
    }
  
    public function add_vacancy(Request $request) {
      $cities = DB::table('cities')->get();
      return view('Subadmin.add_vacancy',compact('cities'));
    }
    ...
    public function edit_vacancy($id) {
      ...
      $cities = DB::table('cities')->get();
      return view('Subadmin.edit_vacancy',compact('vacancy','cities'));
    }
    ...
    public function about()
    {
     ...
     return view('Subadmin.about',compact('about'));
    }

    public function about_us()
    {
      $about = DB::table('about_page')->where('id',1)->first();
     return view('Subadmin.about_us',compact('about'));
    }
    ...
    public function about_save(Request $request)
    {
      ...
      if($exists) {
        ...
        $update = DB::table('about_page')->insert(['about'=>$request->about]);
